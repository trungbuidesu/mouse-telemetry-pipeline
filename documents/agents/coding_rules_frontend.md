...
* React Router cho page routing.
* TanStack Query chỉ cho API/server state.
...
`hot path` là đoạn code chạy rất thường xuyên, ví dụ `mousemove`, canvas drawing hoặc buffer append. Những đoạn này phải tránh re-render, allocation lớn và I/O đồng bộ.
