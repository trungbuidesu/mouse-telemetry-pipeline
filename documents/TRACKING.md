...
> **Tổng tiến độ:** P0 complete (11/11); G0 PASSED; P1-P5 not started
...
| P1 | Frontend Telemetry MVP | `NOT_STARTED` | 0/10 tasks | — | — | Eligible to start after G0; gameplay shell next |
...
| ID | Task | Trạng thái | Ngày hoàn thành | Blocked by | Notes |
|---|---|---|---|---|---|
| T1.1 | Gameplay shell task and playable route integration | `TODO` | — | T0.6 | Placeholder routes đã có từ T0.6; vẫn cần task phase1 và playable shell |
