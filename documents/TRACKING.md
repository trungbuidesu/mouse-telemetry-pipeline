...
> **Tổng tiến độ:** P0 complete (11/11); G0 PASSED; P1 complete (11/11); G1 PASSED; P2 in progress (5/8)
...
| P2    | Ingestion API                 | `IN_PROGRESS` | 5/8 tasks   | 24/07/2026   | —               | FastAPI nhận batch và produce Kafka; next T2.6 |
